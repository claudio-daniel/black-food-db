...
CREATE TABLE `cashes` (
  ...
  CONSTRAINT `fk_cash_turn` FOREIGN KEY (`turn_id`) REFERENCES `turns` (`id`),
...
INSERT INTO `cashes` VALUES (1,1,2,1,400,NULL,'2020-11-13 00:00:00',NULL);
...
CREATE TABLE `departamentos` (
  `id` int NOT NULL,
  `cantidad_habitacion` int DEFAULT NULL,
  `nombre` varchar(255) DEFAULT NULL,
  `edificio_id` int DEFAULT NULL,
  `departamento_estados_id` int DEFAULT NULL,
...
CREATE TABLE `expensas_item` (
  ...
  `mantenimiento_id` bigint DEFAULT NULL,
  `servicio_id` bigint DEFAULT NULL,
  `expensa_id` bigint DEFAULT NULL,
...
INSERT INTO `users` VALUES (1,'Alejandro','Lamas','jano','12345',NULL,NULL,1),(2,'Claudio','Carrizo','claudio','$2a$10$y3fzVblUdrYsoBCM9/BxfOE0vPfCTMGRgFtqpUfIjTva5bEddtai2',NULL,NULL,1),(3,'Mariano','Ortega','marian','12345',NULL,NULL,1);
...
-- Dump completed on 2021-06-22  2:12:30
